...
def parse_song_form(form):
    ...
    form = dict(form)
    if not form.has_key('song-featured'):
...
def can_edit(song):
    ...
    if authenticated():
        if song.adder_id == None:
            return False
        else:
            return session.has_key('user_id') and song.adder_id == session['user_id']
    else:
        return False
...
def new_song():
    ...
    if request.method == 'POST':
        ...
        song = {"id": None, "name": "", "song_url": "",
                  "song_number": "", "description": "", "start_date": "",
...
def edit_song(song_id):
    ...
    if request.method == 'POST':
        ...
        song.song_number = song_params.song_number
        song.description = song_params.description
        song.start_date = song_params.start_date
        ...
        return render_template('edit_song.html',
                               ...
                               form_action=url_for('edit_song', song_id=song_id),
                               logged_in=authenticated)
